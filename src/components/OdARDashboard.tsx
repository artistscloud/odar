...
const HeatMap = ({ data, width, height, maxValue }: { data: number[][], width: number, height: number, maxValue: number }) => {
...
const OdARDashboard = () => {
  ...
  const [environmentalData, setEnvironmentalData] = useState({
    ...
    humidity: 50.0,
    pressure: 1013.25,
    history: [] as EnvironmentalReading[]
  });
  ...
  return (
    <div className="flex flex-col gap-4 p-4 w-full bg-gray-50 rounded-md">
      {/* Status Cards */}
            ...
            <table className="w-full">
              ...
              <tbody>
                {detectionData.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan={4} className="px-4 py-2 text-center text-gray-500">No detections recorded</td>
                  </tr>
                )}
              </tbody>
            </table>
      ...
      <div className="bg-white p-4 rounded-lg shadow-md">
        ...
        <div className="h-32 overflow-y-auto">
          {systemStatus.messages.length > 0 ? (
            ...
            <div className="p-2 text-center text-gray-500">No system messages</div>
          )}
        </div>
      </div>
    </div>
