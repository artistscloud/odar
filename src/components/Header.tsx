  ...
  return (
    <header className="w-full py-6 px-8 flex items-center justify-between">
      <div className="flex items-center space-x-4">
        <div 
          className={`w-12 h-12 rounded-xl bg-gradient-to-br from-odar-blue to-odar-accent flex items-center justify-center transform transition-all duration-700 ${
        ...
        >
          <h1 className="text-2xl font-medium tracking-tight">OdAR System</h1>
          <div className="flex items-center">
            <span className="text-xs uppercase tracking-wider text-odar-gray-500 font-medium">
              Odor Detection & Ranging
            </span>
